...
const HeroSection = () => {
  return (
    <div className="w-full flex md:w-10/12 md:max-w-10/12 mx-auto">
      <div className=" flex flex-col ml-6 md:ml-4 mt-8 md:mt-28">
        <div className="relative">
          ...
          <p className="mt-6 text-[12px] text-gray-600 md:text-gray-500 tracking-wide">
          ...
          <Image
            ...
            width={450}
            height={0}
            className="hidden md:block object-contain absolute top-28 right-20 translate-x-10"
          />
        </div>
        <div className="md:w-7/12 flex items-center justify-baseline gap-6 md:gap-0 md:justify-between mt-8 md:mt-14 text-gray-600">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-baseline gap-2 md:gap-4 mt-6 md:mt-4">
      ...
      <div className="md:w-5/12 relative h-[80vh]">
        <Image
          src="/assets/hero_man-Photoroom.png"
          alt="man hero img"
          fill
          className="hidden md:block absolute left-8 object-cover object-[left_76%_top_50%] z-50"
        />
